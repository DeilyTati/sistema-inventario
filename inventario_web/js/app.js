...
// La aplicación y Spring Boot están en el mismo dominio,
// por eso usamos una ruta relativa:
// /api/productos
//
// DESARROLLO LOCAL:
// Si ejecutas el frontend con Live Server, por ejemplo:
// http://127.0.0.1:5500
// entonces Spring Boot estará en:
// http://localhost:8081
//
// Si ejecutas todo directamente desde Spring Boot en:
// http://localhost:8081
// también funcionará con /api/productos.
//
...
const esPuertoSpringBoot = window.location.port === "8081";

const BACKEND_BASE = (esLocal && !esPuertoSpringBoot)
    ? "http://localhost:8081"
    : "";
...
function mostrarSeccion(nombreSeccion) {
    ...
    const linkActivo = document.getElementById(
        `nav-${nombreSeccion}`
    );
...
function mostrarAlerta(
    ...
    mensajeContenedor.innerHTML = `
        <div
            class="alert alert-${tipo} alert-dismissible fade show shadow-sm rounded-3 d-flex align-items-center mb-4"
            role="alert"
        >
    ...
    if (duracion > 0) {
        ...
        setTimeout(() => {
            ...
            const alerta =
                mensajeContenedor.querySelector(".alert");
...
async function verificarConexionServidor() {
    ...
    const badge =
        document.getElementById("badgeConexion");
    ...
    try {
        ...
        if (respuesta.ok && badge) {
            ...
            badge.className =
                "badge bg-success-subtle text-success border border-success-subtle px-3 py-2 rounded-pill";

            badge.innerHTML =
                '<i class="bi bi-database-check me-1"></i> Conectado a MySQL';
        }
        ...
        if (badge) {
            ...
            badge.className =
                "badge bg-danger-subtle text-danger border border-danger-subtle px-3 py-2 rounded-pill";

            badge.innerHTML =
                '<i class="bi bi-database-exclamation me-1"></i> Servidor Desconectado';
        }
    }
}
...
// =====================================================
// CONSULTAR PRODUCTOS DESDE SPRING BOOT
// =====================================================
...
async function obtenerProductos() {
    ...
    try {
        ...
        console.error(
            "Error al consultar productos desde la API:",
            error
        );


        mostrarAlerta(
            "<strong>Aviso:</strong> No se pudo conectar con el servidor Spring Boot / MySQL.",
            "danger",
            0
        );
...
function renderizarTabla(productos) {
        ...
        tbodyProductos.innerHTML = `
            <tr>
                ...
                >
                    ...
                    <i
                        class="bi bi-box-seam fs-1 d-block mb-2 text-secondary"
                    ></i>
        ...
        const fila = `
            <tr>
                ...
                <td>
                    ...
                    <i
                        class="bi bi-building me-1 text-muted"
                    ></i>
                ...
                <td>
                    ...
                    <span
                        class="badge bg-secondary-subtle text-dark px-2 py-1"
                    >
                ...
                <td>
                    ...
                    <span
                        class="badge ${claseEstado} px-2 py-1"
                    >
    ...
    if (totalGeneral) {
        ...
        totalGeneral.textContent =
            "$" +
            sumaTotalGeneral.toLocaleString("es-CO");
    }
}
    ...
    formProducto.addEventListener(
        ...
        async function(event) {
            ...
            btnGuardar.innerHTML =
                '<span class="spinner-border spinner-border-sm me-2" role="status"></span> Guardando en MySQL...';
...
async function editarProducto(id) {
    ...
    try {
        ...
        console.error(
            "Error al cargar producto para editar:",
            error
        );


        mostrarAlerta(
            "No fue posible cargar los datos del producto para edición.",
            "danger"
        );
    }
}
...
async function eliminarProducto(id) {
    ...
    const confirmar =
        confirm(
            "¿Está seguro de que desea eliminar este producto de la base de datos?"
        );
    ...
    try {
        ...
        mostrarAlerta(
            "Producto eliminado exitosamente de la base de datos MySQL.",
            "success"
        );
        ...
        mostrarAlerta(
            "No fue posible eliminar el producto en el servidor.",
            "danger"
        );
    }
}
